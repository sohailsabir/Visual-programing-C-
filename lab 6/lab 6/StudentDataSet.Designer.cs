...
namespace lab_6 {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class informationDataTable : global::System.Data.TypedTableBase<informationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public informationRow AddinformationRow(int Id, string name, string program) {
        ...
        public partial class informationRow : global::System.Data.DataRow {
            ...
            public string program {
                get {
                    try {
                        return ((string)(this[this.tableinformation.programColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'program\' in table \'information\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableinformation.programColumn] = value;
                }
            }
            ...
            public bool IsprogramNull() {
                return this.IsNull(this.tableinformation.programColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetprogramNull() {
                this[this.tableinformation.programColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace lab_6.StudentDataSetTableAdapters {
    ...
    public partial class informationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[information] WHERE (([Id] = @Original_Id) AND ([name] = @Origi" +
                "nal_name) AND ((@IsNull_program = 1 AND [program] IS NULL) OR ([program] = @Orig" +
                "inal_program)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[information] ([Id], [name], [program]) VALUES (@Id, @name, @pr" +
                "ogram);\r\nSELECT Id, name, program FROM information WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[information] SET [Id] = @Id, [name] = @name, [program] = @program WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ((@IsNull_program = 1 AND [program] IS NULL) OR ([program] = @Original_program)));
SELECT Id, name, program FROM information WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::lab_6.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, program FROM dbo.information";
        ...
        public virtual int Fill(StudentDataSet.informationDataTable dataTable) {
        ...
        public virtual StudentDataSet.informationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDataSet.informationDataTable dataTable = new StudentDataSet.informationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDataSet.informationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_program) {
        ...
        public virtual int Insert(int Id, string name, string program) {
        ...
        public virtual int Update(int Id, string name, string program, int Original_Id, string Original_name, string Original_program) {
            ...
            if ((Original_program == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_program));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string program, int Original_Id, string Original_name, string Original_program) {
            return this.Update(Original_Id, name, program, Original_Id, Original_name, Original_program);
        }
    }
